<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href=" /dashboard " target="_blank">
      ...
      <span class="ms-1 font-weight-bold">Aplikasi Rental Ukrim</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <li class="nav-item">
          <a class="nav-link  " href="{{url('pesanan/keranjang')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Lihat Pesanan Anda</span>
          </a>
        </li>
      @can('superadmin')
      <li class="nav-item">
        <a class="nav-link  " href="{{url('/motor')}}">
          ...
          <span class="nav-link-text ms-1">List Motor</span>
        </a>
      </li>
      <li class="nav-item">
      <li class="nav-item">
        <a class="nav-link  " href="{{url('/syarat')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">Syarat Pemesanan</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link  " href="{{url('/pesanan')}}">
          ...
          <span class="nav-link-text ms-1">Pemesanan Motor</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link  " href="/itemtransactions">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text ms-1">Rincian Pembayaran</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link  " href="/app">
          ...
          <span class="nav-link-text ms-1">Peminjaman Motor</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link  " href="/transaksi">
          ...
          <span class="nav-link-text ms-1">Data Booking Motor</span>
        </a>
      </li>
      @endcan
      ...
      <li class="nav-item">
        <a class="nav-link  " href="/resgister">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <div class="sidenav-footer mx-3 ">
    <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
      ...
      <div class="card-body text-start p-3 w-100">
        ...
        <div class="docs-info">
          <h6 class="text-white up mb-0">Follow Instagram</h6>
          <p class="text-xs font-weight-bold">Ludger</p>
